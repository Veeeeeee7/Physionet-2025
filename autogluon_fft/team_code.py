...
def train_model(data_folder, model_folder, verbose):
    log_file = '/users/vmli3/physionet-2025/autogluon_fft/log.txt'
    ...
    if verbose:
        print(f'Feature extraction and labeling completed in {elapsed_time:.2f} seconds.')
    ...
    autogluon.leaderboard(data=train_df, extra_metrics=['f1', 'roc_auc']).to_csv("/users/vmli3/physionet-2025/autogluon_fft/leaderboard.csv", index=False)
    ...
    scores_file = "/users/vmli3/physionet-2025/autogluon_fft/scores.txt"
