...
def compute_fft(ecg_signal, fs):
    ...
    elif len(ecg_signal) < 200:
        target_length = 200
        total_padding = target_length - len(ecg_signal)
        padding = total_padding // 2
        ecg_signal = np.pad(ecg_signal, (padding, total_padding - padding), 'constant', constant_values=(0, 0))
