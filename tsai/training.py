...
def log(message):
    with open('/users/vmli3/physionet-2025/tsai/log.txt', 'a') as f:
        f.write(f"{message} \n")
        print(message)

if os.path.exists('/users/vmli3/physionet-2025/tsai/log.txt'):
    os.remove('/users/vmli3/physionet-2025/tsai/log.txt')
...
for i, (arch, k) in enumerate(archs):
    ...
    for split in range(1):
        ...
        #         learn = Learner(train_dls, model, loss_func=FocalLoss()) #FBeta is basically F1
