    ...
    for k in range(num_groups):
        ...
        with h5py.File(signal_file, 'r') as f:
            ...
            for i in range(num_exam_ids):
                ...
                comments.append(f'1dAVb: {_1dAVb}')
                comments.append(f'RBBB: {RBBB}')
                comments.append(f'LBBB: {LBBB}')
                comments.append(f'SB: {SB}')
                comments.append(f'ST: {ST}')
                comments.append(f'AF: {AF}')
